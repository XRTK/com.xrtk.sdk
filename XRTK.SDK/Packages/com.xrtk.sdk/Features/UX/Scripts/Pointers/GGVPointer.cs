            ...
            if (eventData.SourceId == InputSourceParent.SourceId)
            {
                if (eventData.MixedRealityInputAction == selectAction)
                {
                    ...
                    if (IsInteractionEnabled)
                    {
                        ...
                        MixedRealityToolkit.InputSystem.RaisePointerClicked(this, selectAction, 0, Controller.InputSource);
                        MixedRealityToolkit.InputSystem.RaisePointerUp(this, selectAction, Controller.InputSource);
                    }
                }
            }
        }
            ...
            if (eventData.SourceId == InputSourceParent.SourceId)
            {
                if (eventData.MixedRealityInputAction == selectAction)
                {
                    ...
                    if (IsInteractionEnabled)
                    {
                        ...
                        MixedRealityToolkit.InputSystem.RaisePointerDown(this, selectAction, Controller.InputSource);
                    }
                }
            }
        }
