                    ...
                    else if (canMove)
                    {
                        ...
                        if (offsetRotationAngle > 0)
                        {
                            ...
                            if (offsetRotationAngle < rotateActivationAngle)
                            {
                                ...
                                MixedRealityToolkit.CameraSystem.CameraRig.PlayspaceTransform.RotateAround(CameraCache.Main.transform.position, Vector3.up, angle >= 0.0f ? rotationAmount : -rotationAmount);
                            }
                            else // We may be trying to strafe backwards.
                            {
                                ...
                                {
                                    canMove = false;
                                    var playspacePosition = MixedRealityToolkit.CameraSystem.CameraRig.PlayspaceTransform.position;
                                    var height = playspacePosition.y;
                                    var newPosition = -CameraCache.Main.transform.forward * strafeAmount + playspacePosition;
                                    newPosition.y = height;
                                    MixedRealityToolkit.CameraSystem.CameraRig.PlayspaceTransform.position = newPosition;
                                }
                            }
                        }
                    }
